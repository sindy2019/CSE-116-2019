...
/**
  * The entire calculator.view package will be deleted before grading. Do not add any functionality in your view.
  * This GUI is only provided as an example of how your controller and model would be used by a view
  */
